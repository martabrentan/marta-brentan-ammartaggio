# Marta Brentan – Portfolio

Sito personale di Marta Brentan, editor e UX/UI designer.  
Realizzato con **HTML**, **SCSS**, **Bootstrap 5** e un tocco di JavaScript.  
...
Oppure visitare la versione online tramite GitHub Pages.
